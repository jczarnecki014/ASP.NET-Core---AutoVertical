...
namespace AutoVerticalData.Migrations
{
    ...
    [Migration("20230116062400_DeleteMessagesOrderFromMessagesTable")]
    partial class DeleteMessagesOrderFromMessagesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoVertical_Model.Models.Conversation", b =>
                {
                    ...
                    b.Property<string>("WritingUserId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AutoVertical_Model.Models.Message", b =>
                {
                    b.HasOne("AutoVertical_Model.Models.Conversation", "Conversation")
                        .WithMany()
