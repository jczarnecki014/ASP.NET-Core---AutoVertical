...
namespace AutoVerticalData.Migrations
{
    ...
    [Migration("20230207061602_AddCompanyRoleToApplicationUser")]
    partial class AddCompanyRoleToApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoVertical_Model.Models.Company", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoVertical_Model.Models.Notyfications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UserOfEventId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("UserOfEventId");
            ...
            modelBuilder.Entity("AutoVertical_Model.Models.Notyfications", b =>
                {
                    b.HasOne("AutoVertical_Model.Models.ApplicationUser", "UserOfEvent")
                        .WithMany()
                        .HasForeignKey("UserOfEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
